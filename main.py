    """
    Llm Playground 8vsuy
    ====================
    A Python-based AI utility that labels text using modern language model APIs.
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="A Python-based AI utility that labels text using modern language model APIs.")
